...
class FilmTest {
    ...
    @Test
    void testGetFilm_id() {
        Film testFilm = new Film("title", "description", 2000, 1, 1, 300, 10);
    ...
    void testGetReleaseYear() {
        Film testFilm = new Film("title", "description", 2000, 1, 1, 300, 10);
        testFilm.setRelease_year(2000);
        Assertions.assertEquals(2000, testFilm.getRelease_year(), "release year is not present");
    }
    ...
    void testGetLanguage_id() {
        ...
        Assertions.assertEquals(1, testFilm.getLanguage_id(), "language_id is not present");
    }
